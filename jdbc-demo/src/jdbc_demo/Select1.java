...
public class Select1 {
        ...
        public static HashMap<Integer,Integer> select_productOrder(String findItem, String x) throws SQLException, ClassNotFoundException{
        ...
        public static Order select_order(String OrderId) throws SQLException, ClassNotFoundException{
            //订单不存在->Order全部为null
            ...
            if (rs.next()) {
                ...
                HashMap<Integer,Integer>hm=select_productOrder("订单编号",OrderId);
        ...
        public static Product select_product(String pname) throws SQLException, ClassNotFoundException {
